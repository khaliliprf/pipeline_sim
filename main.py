...
p1 = Pipeline(instructions=deepcopy(benchmark1), enable_forwarding=False)
p1.run()

# no branch - test stall in forwarding
p2 = Pipeline(instructions=deepcopy(benchmark1), enable_forwarding=True)
p2.run()
...
p3 = Pipeline(instructions=deepcopy(benchmark2), enable_forwarding=False)
p3.run()

# with branch - forwarding
p4 = Pipeline(instructions=deepcopy(benchmark2), enable_forwarding=True)
p4.run()
...
# final test 
# #  no forwarding 
p5 = Pipeline(instructions=deepcopy(benchmark3), enable_forwarding=False)
p5.run()

# #  forwarding
p6 = Pipeline(instructions=deepcopy(benchmark3), enable_forwarding=True)
p6.run()